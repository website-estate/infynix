  ...
  return (
    <footer suppressHydrationWarning className="bg-[var(--black-1000)] pt-24 pb-12 border-t border-white/5 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Top Section: 3-Column Footer Layout */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16 mb-20">

          {/* Column 1: Brand & Socials */}
          <div className="flex flex-col gap-8">
            <img src="/assets/footer_logo.svg" alt="Infynix Logo" className="h-10 w-auto object-contain" style={{ maxWidth: "max-content" }} />
          ...
          <div className="group">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-white/20 text-[10px] font-black uppercase tracking-[0.2em]">Contact & Support</span>
            </div>
            
            <div className="mb-8">
              <div className="text-white font-bold text-base mb-1">+91 9558037367</div>
              <div className="text-white/40 text-sm">Mon - Fri, 9am - 6pm</div>
            </div>
            
            <div>
              <div className="text-white font-bold text-[15px] lg:text-base mb-1">support.infynixinfotech@gmail.com</div>
              <div className="text-white/40 text-sm">Response within 24 hours</div>
            </div>
          </div>
          ...
          <div className="group">
            ...
            <div className="mb-6">
              <div className="text-white font-bold text-base mb-1">Silver Trade Centre</div>
              <div className="text-white/40 text-sm">STC, Utran</div>
            </div>
          </div>
